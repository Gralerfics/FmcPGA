...
#
# Generated by export_simulation on Fri Mar 24 20:17:14 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './bram_disp.sh' script.

./bram_disp.sh -reset_run
...
./bram_disp.sh -noclean_files

For more information on the script, please type './bram_disp.sh -help'.
