...
#
# Generated by export_simulation on Sat Mar 25 19:51:08 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './bram_radar.sh' script.

./bram_radar.sh -reset_run
...
./bram_radar.sh -noclean_files

For more information on the script, please type './bram_radar.sh -help'.
