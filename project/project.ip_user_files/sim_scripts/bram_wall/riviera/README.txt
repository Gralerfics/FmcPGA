...
#
# Generated by export_simulation on Fri Mar 24 23:14:24 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './bram_wall.sh' script.

./bram_wall.sh -reset_run
...
./bram_wall.sh -noclean_files

For more information on the script, please type './bram_wall.sh -help'.
