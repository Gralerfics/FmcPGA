...
#
# Generated by export_simulation on Sun Apr 09 08:36:42 CST 2023
#
################################################################################
...
'-reset_run' switch to the './disp_buffer_1.sh' script.

./disp_buffer_1.sh -reset_run
...
./disp_buffer_1.sh -noclean_files

For more information on the script, please type './disp_buffer_1.sh -help'.
