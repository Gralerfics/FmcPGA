...
#
# Generated by export_simulation on Wed Mar 22 14:37:50 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './mig_ddr.sh' script.

./mig_ddr.sh -reset_run
...
./mig_ddr.sh -noclean_files

For more information on the script, please type './mig_ddr.sh -help'.
