...
#
# Generated by export_simulation on Wed Mar 22 01:57:15 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './vga_clk_generator.sh' script.

./vga_clk_generator.sh -reset_run
...
./vga_clk_generator.sh -noclean_files

For more information on the script, please type './vga_clk_generator.sh -help'.
