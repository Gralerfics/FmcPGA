...
HD_PWD='C:/Workplace/SUSTech-EE332-Digital-System-Designing-Project/project/project.runs/bram_disp_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bram_disp.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bram_disp.tcl
