...
HD_PWD='C:/Workplace/SUSTech-EE332-Digital-System-Designing-Project/project/project.runs/bram_wall_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bram_wall.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bram_wall.tcl
