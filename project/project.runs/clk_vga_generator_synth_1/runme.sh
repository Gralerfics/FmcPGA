...
HD_PWD='/home/gralerfics/MyFiles/Workspace/SUSTech-EE332-Digital-System-Designing-Project/project/project.runs/clk_vga_generator_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_vga_generator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_vga_generator.tcl
