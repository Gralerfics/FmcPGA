...
HD_PWD='/home/gralerfics/MyFiles/Workspace/SUSTech-EE332-Digital-System-Designing-Project/project/project.runs/display_ram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log display_ram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source display_ram.tcl
