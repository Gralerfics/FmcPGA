...
HD_PWD='C:/Workplace/SUSTech-EE332-Digital-System-Designing-Project/project/project.runs/mig_ddr_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mig_ddr.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mig_ddr.tcl
