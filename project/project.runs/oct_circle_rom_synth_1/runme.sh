...
HD_PWD='/home/gralerfics/MyFiles/Workspace/SUSTech-EE332-Digital-System-Designing-Project/project/project.runs/oct_circle_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log oct_circle_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source oct_circle_rom.tcl
