...
HD_PWD='C:/Workplace/SUSTech-EE332-Digital-System-Designing-Project/project/project.runs/ram_clk_generator_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ram_clk_generator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ram_clk_generator.tcl
