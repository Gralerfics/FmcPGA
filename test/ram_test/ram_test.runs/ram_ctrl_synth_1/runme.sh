...
HD_PWD='C:/Workplace/SUSTech-EE332-Digital-System-Designing-Project/test/ram_test/ram_test.runs/ram_ctrl_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ram_ctrl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ram_ctrl.tcl
